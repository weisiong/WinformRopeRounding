...
namespace SimpleRTSPPlayerWinforms
{
    public partial class VideoControl : UserControl
    {
        ...
        public event EventHandler HandleStreamStartedEvent;
        public event EventHandler HandleStreamStoppedEvent;
        public event EventHandler<string> HandleStreamFailedEvent;
        ...
        public async  void StartPlay(string url)
        {
            ...
            using (var rtspClient = new RtspClient(connectionParameters))
            {
                ...
                while (true)
                {
                    ...
                    {
                        HandleStreamFailedEvent?.Invoke(this, e.Message);
                        return;
                    }
        ...
        public  void Stop()
        {
            ...
            {
                IsPlaying = false;
                HandleStreamStoppedEvent?.Invoke(this, null);
            }
        }

        public Image GetCurrentFrame() => bmp;
        ...
        private void RtspClient_FrameReceived(object sender, RtspClientSharp.RawFrames.RawFrame e)
        {
            ...
            {
                IsPlaying = true;
                HandleStreamStartedEvent?.Invoke(this, null);
            }
        }
