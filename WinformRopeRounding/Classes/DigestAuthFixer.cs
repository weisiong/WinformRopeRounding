...
namespace WinformRopeRounding.Classes
{
    public class DigestAuthFixer
    {
        ...
        //{
        //    _nc = _nc + 1;
        //    _realm = "gSOAP Web Service";
        //    _nonce = "4e4467304d6a46424e4551364d54633059544e6d4e6a513d";
        //    _cnonce = "F12A06A01AF335701B1944D96363AE5F";
        //    _qop = "auth";
        //    var ha1 = CalculateMd5Hash(string.Format("{0}:{1}:{2}", _user, _realm, _password));
        //    var ha2 = CalculateMd5Hash(string.Format("{0}:{1}", "GET", dir));
        //    //var digestResponse =  CalculateMd5Hash(string.Format("{0}:{1}:{2:00000000}:{3}:{4}:{5}", ha1, _nonce, _nc, _cnonce, _qop, ha2));
        //    var digestResponse = "1335d1c59a4b38b115d35544055ab001";
        //    return string.Format("Digest username=\"{0}\", realm=\"{1}\", nonce=\"{2}\", uri=\"{3}\", " +
        //        "algorithm=\"MD5\", response=\"{4}\", qop=\"{5}\", nc={6:00000000}, cnonce=\"{7}\"",
        //        _user, _realm, _nonce, dir, digestResponse, _qop, _nc, _cnonce);
        //}
        ...
        public string GrabResponse(string dir)
        {
            ...
            {
                var header = GetDigestHeader(dir);
