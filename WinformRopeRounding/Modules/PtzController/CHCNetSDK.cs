    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public struct NET_DVR_FOCUSMODE_CFG
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_TRANSPARENTNUM, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1; //ArrSize = 2  
            public uint dwRelativeFocusPos;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = SERIALNO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes; //ArrSize = 48
        }
